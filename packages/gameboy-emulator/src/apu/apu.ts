...
export class APU {
  ...
  private audioContext = new RemoteAudioContext({ sampleRate: 44100 });
  ...
  private ringBufferPlayer: RemoteRingBufferPlayer;
  ...
  constructor() {
    ...
    this.ringBufferPlayer = new RemoteRingBufferPlayer(this.audioContext, 1024);
