...
import { sound2EnvelopeControlRegister } from "./registers/envelope-control-registers.js";
import { sound2HighOrderFrequencyRegister } from "./registers/high-order-frequency-registers.js";
import { sound2LengthAndDutyCycleRegister } from "./registers/length-and-duty-cycle-registers.js";
import { sound2LowOrderFrequencyRegister } from "./registers/low-order-frequency-registers.js";
...
export class Sound2 {
  ...
  playSound() {
    ...
    this.enveloper.initializeTimer(
      sound2EnvelopeControlRegister.lengthOfEnvelopeStep
    );
  ...
  clockVolume() {
    this.volume = this.enveloper.clockVolume(
      this.volume,
      sound2EnvelopeControlRegister
    );
  }

  getSample() {
    const sample =
      this.dutyCycles[sound2LengthAndDutyCycleRegister.waveformDutyCycle][
  ...
  private getFrequencyPeriod() {
    const rawValue =
      memory.readWord(sound2LowOrderFrequencyRegister.offset) & 0b11111111111;
