...
export const sound1EnvelopeControlRegister = new EnvelopeControlRegister(
  0xff12,
  "NR12"
);
export const sound2EnvelopeControlRegister = new EnvelopeControlRegister(
  0xff17,
  "NR22"
);
export const sound4EnvelopeControlRegister = new EnvelopeControlRegister(
  0xff21,
  "NR42"
);
